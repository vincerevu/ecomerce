  ...
  return (
    <div className="bg-white shadow-1 rounded-[10px]">
      ...
      <div className={`${dropdown ? "block" : "hidden"} pt-7.5 pb-8.5 px-4 sm:px-8.5`}>
        <p className="text-custom-sm mb-6">Nếu bạn chưa đăng nhập, vui lòng đăng nhập trước.</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" disabled={loading} className="inline-flex font-medium text-white bg-blue py-3 px-10.5 rounded-md ease-out duration-200 hover:bg-blue-dark disabled:bg-opacity-50">
