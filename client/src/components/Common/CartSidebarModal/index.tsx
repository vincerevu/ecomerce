...
const CartSidebarModal = () => {
  ...
  const selectedItemCount = useAppSelector(
    (state) => state.cartReducer.selectedItemIds.length
  );
          ...
          <div className="border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5 sticky bottom-0">
            <div className="flex items-center justify-between gap-5 mb-6">
              <div>
                ...
                <p className="text-sm text-dark-4">{selectedItemCount} sản phẩm được chọn</p>
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/checkout"
                onClick={() => closeCartModal()}
                aria-disabled={selectedItemCount === 0}
                className={`w-full flex justify-center py-[13px] px-6 rounded-md font-medium ease-out duration-200 ${
                  selectedItemCount > 0
                    ? "bg-blue text-dark hover:bg-blue-dark"
