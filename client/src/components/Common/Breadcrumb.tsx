...
const Breadcrumb = ({ title, pages, compact = false }) => {
  return (
    <div
      className={`overflow-hidden shadow-breadcrumb ${
        compact
          ? "pt-[132px] sm:pt-[126px] lg:pt-[88px] xl:pt-[110px]"
      ...
      <div className="border-t border-gray-3">
        <div
          className={`max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0 ${
            compact ? "py-4 xl:py-6" : "py-5 xl:py-10"
          }`}
        >
