          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 px-4 sm:px-7.5 xl:pl-12.5 xl:pr-14 py-11">
            <div className="max-w-[491px] w-full">
              <h2 className="max-w-[399px] text-white font-bold text-lg sm:text-xl xl:text-heading-4 mb-3">
                Đừng bỏ lỡ xu hướng mới nhất & Ưu đãi
              </h2>
              ...
              <form>
                <div className="flex flex-col sm:flex-row gap-4">
                  <input
                    ...
                    className="w-full bg-gray-1 border border-gray-3 outline-none rounded-md placeholder:text-dark-4 py-2.5 px-5"
                  />
                  <button
                    type="submit"
                    className="inline-flex justify-center py-2.5 px-9 text-white bg-blue font-medium rounded-md ease-out duration-200 hover:bg-blue-dark whitespace-nowrap"
                  >
                    Đăng ký
                  </button>
                </div>
