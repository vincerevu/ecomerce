...
const config: Config = {
  ...
  theme: {
    ...
    colors: {
      ...
      dark: {
        DEFAULT: "#111827", // Darker Black for fashion
        2: "#1F2937",
        3: "#374151",
        4: "#4B5563",
        5: "#9CA3AF",
      ...
      // Keep original blue for backward compatibility but mapped to new fashion theme if needed,
      // or just keep as utility.
      blue: {
        DEFAULT: "#FFC954",
        dark: "#FFB400",
        light: "#FFD97A",
