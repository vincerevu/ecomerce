...
import com.project.ecommerce.modules.order.dto.response.CartItemResponse;
...
import com.project.ecommerce.modules.order.entity.CartItem;
import com.project.ecommerce.modules.order.repository.CartItemRepository;
import com.project.ecommerce.modules.order.repository.CartRepository;
...
public class CheckoutCartService {
    ...
    public CartResponse addItem(String userId, CartItemRequest request) {
        ...
        ProductVariant variant = findVariantForSnapshot(request.getProductVariantId());
    ...
    private ProductVariant findVariantForSnapshot(String productVariantId) {
